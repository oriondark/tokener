                            ...
                            renderRow={data => {
                                return (
                                    <CardItem header>
                                        ...
                                        <Body>
                                            <Text>{data.name}</Text>
                                            <Text note>{data.typenote}</Text>
                                        </Body>
                                        <Right>
                                            <Icon name={data.typeicon} style={{ color: '#DD5044' }} />
                                            <Text>{data.type}</Text>
                                            <Text>{data.typetokens}<Thumbnail source={require('firstapp/img/cents.png')} /></Text>
                                        </Right>
                                    </CardItem>
                                );
                            }}
